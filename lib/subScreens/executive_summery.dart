...
class ExecutiveSummery extends StatefulWidget {
  final String userdata;
  const ExecutiveSummery({key, this.userdata}) : super(key: key);

  @override
  _ExecutiveSummeryState createState() => _ExecutiveSummeryState();
}

class _ExecutiveSummeryState extends State<ExecutiveSummery> {
  ...
  Future<List<ExcOrders>> fetchNotes() async {
    ...
    var url = "$baseURL/sale.order.line?filters=[('salesman_id','=',$refId),('state','=','draft')]";
